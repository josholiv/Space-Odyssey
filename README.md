...
- Callouts with per-type accent colours and themed backgrounds (dark and light)
- Internal and external links use distinct colours for quick differentiation

## Installation

1. Download `theme.css` and `manifest.json` from this repo
2. Place them in your vault under `.obsidian/themes/Space Odyssey/`
3. Open Obsidian → **Settings → Appearance → Themes** and select **Space Odyssey**
...
This theme imports fonts from Google Fonts. An internet connection is required on first load for the fonts to render correctly.
